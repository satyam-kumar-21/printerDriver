...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-sky-50 via-white to-white py-16 sm:py-20 lg:py-28">
      {/* Background Effects */}
      <div className="absolute inset-0">
        <div className="absolute left-[-10%] top-[-10%] h-100 w-100 rounded-full bg-blue-200/50 blur-[120px]" />
        <div className="absolute right-[-10%] top-[10%] h-100 w-100 rounded-full bg-sky-200/40 blur-[120px]" />
        ...
        <div className="grid gap-8 sm:gap-12 lg:grid-cols-[1.1fr_0.9fr] items-start">
          ...
          <div>
            <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 rounded-full border border-sky-200 bg-white px-3 sm:px-4 py-1.5 sm:py-2 shadow-sm shadow-slate-200/50">
              ...
              <span className="text-xs sm:text-xs font-semibold uppercase tracking-wider text-slate-500">
            ...
            <div className="mt-6 sm:mt-10 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
              <Link
                href="/drivers"
                className="group flex justify-center sm:justify-start items-center gap-2 rounded-xl sm:rounded-2xl bg-linear-to-r from-blue-600 to-cyan-500 px-4 sm:px-6 py-3 sm:py-3.5 font-medium text-white text-sm sm:text-base transition-all duration-300 hover:scale-105"
              >
                Explore Drivers
          ...
          <div className="relative w-full md:block">
            <div className="rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-4 sm:p-6 shadow-xl shadow-slate-200/40">
              <div className="mb-4 sm:mb-6 flex items-center gap-3 sm:gap-4">
                <div className="flex h-10 sm:h-12 w-10 sm:w-12 items-center justify-center rounded-xl sm:rounded-2xl bg-linear-to-br from-blue-600 to-sky-500 shrink-0">
                  <Printer className="h-5 w-5 sm:h-5 sm:w-5 text-white" />
                </div>
